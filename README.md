...
[![CI](https://img.shields.io/github/actions/workflow/status/Kuestenlogik/Bowire.Protocol.Dis/ci.yml?branch=main&label=CI)](https://github.com/Kuestenlogik/Bowire.Protocol.Dis/actions/workflows/ci.yml)
